        ...
        <div class="order-2 lg:order-1 lg:col-span-1 xl:col-span-3">
            <div class="bg-white rounded-lg shadow p-6">
                <div class="mb-4">
                    ...
                    <x-jet-input dusk="contactInputOrder" type="text"
                ...
                <div>
                    ...
                    <x-jet-input dusk="telfInputOrder" type="text"
            ...
            <div x-data="{ envio_type: @entangle('envio_type') }">
                ...
                <label dusk="pickUpInShopBtn" class="bg-white rounded-lg shadow px-6 py-4 flex items-center mb-4">
                ...
                <div class="bg-white rounded-lg shadow">
                    <label dusk="homeDeliveryBtn" class="px-6 py-4 flex items-center">
                    ...
                    <div class="px-6 pb-6 grid grid-cols-2 gap-6" :class="{ 'hidden': envio_type != 2 }">
                        <div>
                            ...
                            <select dusk="departmentSelect" class="form-control w-full" wire:model="department_id">
                                <option value="" disabled selected>Seleccione un departamento</option>
                                @foreach($departments as $department)
                                    <option dusk="department_{{ $department->id }}" value="{{ $department->id }}">{{ $department->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <select dusk="citySelect" class="form-control w-full" wire:model="city_id">
                                <option value="" disabled selected>Seleccione una ciudad</option>
                                @foreach($cities as $city)
                                    <option dusk="city_{{ $city->id }}" value="{{ $city->id }}">{{ $city->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <select dusk="districtSelect" class="form-control w-full" wire:model="district_id">
                                <option value="" disabled selected>Seleccione un distrito</option>
                                @foreach($districts as $district)
                                    <option dusk="district_{{ $district->id }}" value="{{ $district->id }}">{{ $district->name }}</option>
                                @endforeach
                            </select>
