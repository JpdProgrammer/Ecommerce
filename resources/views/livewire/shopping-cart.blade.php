<div class="container py-8">
    <x-table-responsive>
        ...
        @if(Cart::count())
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-500">
                                ...
                                <a dusk="deleteProductCartButton" class="ml-6 cursor-pointer hover:text-red-600"
            ...
            <div class="px-6 py-4">
                <a dusk="emptyCartButton" class="text-sm cursor-pointer hover:underline mt-3 inline-block"
                   wire:click="destroy">
                    <i class="fas fa-trash"></i>
