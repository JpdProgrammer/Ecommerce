<div class="flex-1 relative">
    ...
    <x-jet-input dusk="searchProductInput" name="name" wire:model="search" type="text" class="flex w-full" placeholder="¿Estás buscando algún producto?"></x-jet-input>

    <button dusk="searchBarBtn" class="absolute top-0 right-0 w-12 h-full bg-orange-500 flex items-center justify-center rounded-r-md">
