    ...
    <x-jet-dropdown width="96">
        <x-slot name="trigger">
            <span class="relative inline-block">
                ...
                text-red-100 transform translate-x-1/2 -translate-y-1/2 bg-red-600 rounded-full">{{ \Gloudemans\Shoppingcart\Facades\Cart::count() }}</span>
                @else
        ...
        <x-slot name="content">
            ...
            @if(Cart::count())
                <div class="px-3 py-2" >
                    ...
                    <x-button-link dusk="goToCartButton" href="{{ route('shopping-cart') }}" class="w-full" color="orange">
