<div>
    <x-jet-form-section submit="save" class="mb-6">
        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <x-jet-input disabled wire:model.defer="createForm.slug" type="text" class="w-full mt-1 bg-gray-100" />
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <input wire:model.defer="createForm.image" accept="image/*" type="file" class="mt-1" name="" id="{{ $image }}">
                    ...
                    <tr>
                        ...
                        <td class="py-2">
                            <div class="flex divide-x divide-gray-300 font-semibold">
                                ...
                                <a class="pr-2 hover:text-red-600 cursor-pointer"
    ...
    <x-jet-dialog-modal wire:model.defer="editForm.open">
        <x-slot name="title">
            Editar categoría
        </x-slot>
        ...
        <x-slot name="content">
            <div class="space-y-3">
                ...
                <div>
                    ...
                    <x-jet-input wire:model="editForm.icon" type="text" class="w-full mt-1" />
